...
return [
	...
	'routes' => [
		...
		'account' => ['prefix' => 'account', 'middleware' => ['web', 'auth']], // /account/* — avoids conflict with Breeze /profile
	...
	'csp' => [
		'backend' => "style-src 'unsafe-inline' 'self' https://cdnjs.cloudflare.com; font-src 'self' https://cdnjs.cloudflare.com; script-src 'unsafe-eval' 'self'; connect-src 'self' https://*.deepl.com https://api.openai.com; img-src 'self' data: blob: https://*.tile.openstreetmap.org https://aimeos.org; frame-src https://www.youtube.com https://player.vimeo.com",
	],
